...
export async function createRating(request: NextRequest) {
  try {
    ...
    await createNotification(db, {
      ...
      message: `${userName} rated inquiry ${inquiry.id} ${rating} out of 5.`,
      href: "/dashboard/records",
      inquiryId: inquiry.id,
      actorId: userId,
      actorName: userName,
      dedupeKey: `rating-received:${inquiry.id}:${userId}`,
    })
